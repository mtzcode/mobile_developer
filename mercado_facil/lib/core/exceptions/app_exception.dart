...
class AppException implements Exception {
  ...
  /// Construtor para sessão expirada
  factory AppException.sessionExpired({
    ...
    return AppException(
      ...
      userMessage: userMessage ?? 'Sua sessão expirou. Faça login novamente',
  ...
  /// Construtor para erro do servidor
  factory AppException.serverError({
    ...
    return AppException(
      ...
      userMessage: userMessage ?? 'Erro interno do servidor. Tente novamente mais tarde',
      code: 'SERVER_ERROR',
      originalError: originalError,
      stackTrace: stackTrace,
    );
  ...
  /// Construtor para erro de conexão
  factory AppException.connectionError({
    String? message,
    String? userMessage,
    dynamic originalError,
    StackTrace? stackTrace,
    ...
    return AppException(
      ...
      userMessage: userMessage ?? 'Falha na conexão. Verifique sua internet e tente novamente',
